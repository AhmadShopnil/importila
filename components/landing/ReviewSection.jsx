                    ...
                    >
                        {reviews.map((review) => (
                            <SwiperSlide key={review._id}>
                                <div className="group bg-card border border-border rounded-4xl p-4 h-full transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 relative overflow-hidden">
